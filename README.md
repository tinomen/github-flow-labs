...
- **Step 4️⃣:** Run your typical staging, commit and publish commands:
  ...
  - 💥**note:** you're pushing to your branch NOT to the master branch. (VERY IMPORTANT)💥
- **Step 5️⃣:** Pull down the master branch onto your branch. The easiest way to do this is to simply run `git pull origin master` **but make sure you're on your branch first** `git branch`.
...
- **Step 7️⃣:** Open up your **Pull-request**. Now that you've resolved merge conflict and you're sure that your feature branch is up to date with Master open up a pull-request:
